...
# MQTT Configuration
MQTT_BROKER = os.getenv('MQTT_BROKER', '10.12.93.246')  # Assuming broker runs locally on MacBook Pro
...
EXPECTED_DEVICES = int(os.getenv('EXPECTED_DEVICES', 2))  # Set this to the number of your end devices
...
def aggregate_and_publish_models():
    ...
    for device_id in device_ids:
        model_b64 = received_models[device_id]
